...
* General Keybindings
  Space cadet follow your leader's orders!
	...
	(lgreen/leader-keys
	  "j" '(:ignore t :wk "jump")
	  "j j" '(evilem-motion-next-line :wk "next-line")
	  "j k" '(evilem-motion-previous-line :wk "previous-line")
	  "j g" '(:ignore t :wk "avy")
	  "j g g" '(evil-avy-goto-char-2 :wk "goto-char-2")
	  "j g j" '(avy-goto-word-0-below :wk "word-0-below")
	  "j g k" '(avy-goto-word-0-above :wk "word-0-above")
	  "j w" '(evilem-motion-forward-word-begin :wk "forward-word-begin")
	  "j b" '(evilem-motion-backward-word-begin :wk "backward-word-begin")
	  "j e" '(evilem-motion-forward-word-end :wk "forward-word-end")
	  "j W" '(evilem-motion-forward-WORD-begin :wk "forward-WORD-begin")
	  "j E" '(evilem-motion-forward-WORD-end :wk "forward-WORD-end"))
