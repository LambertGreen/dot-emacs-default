...
* In the beginning
A package manager got boostrapped and started sending things packing.
...
#+end_src
* Rest
We are slowly migrating our conifg into a literate config.  This section is the unmigrated stuff.
#+begin_src emacs-lisp
